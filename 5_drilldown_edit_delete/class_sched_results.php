...
<div id="container">
    ...
    while($currentrow = $results->fetch_assoc()) {
        echo "<div class='header'><strong>" .
            "<a href='class_sched_details.php?classid=" .
            ...
            "<a href='class_sched_details.php?classid=". $currentrow["class_sched_id"] ."'>View</a>  | " .
            "<a href='class_sched_edit.php?classid=". $currentrow["class_sched_id"] ."'>Edit</a> " .
            "</div>"  .
            "<br style='clear:both;'>";
