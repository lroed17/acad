...
<div id="container">
    ...
    while($currentrow = $results->fetch_assoc()) {
        echo "<div class='title'><strong>" .
            ...
            "<a href='details_drilldown.php?recordid=". $currentrow["dvd_title_id"] ."'>View</a>  | " .
            "<a href='edit_drilldown.php?recordid=". $currentrow["dvd_title_id"] ."'>Edit</a>  | " .
            "<a href='delete_drilldown.php?recordid=". $currentrow["dvd_title_id"] ."'>Delete</a>  " .
